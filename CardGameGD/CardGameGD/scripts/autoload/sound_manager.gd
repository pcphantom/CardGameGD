...
#
# Accessible globally via: SoundManager.play_sound(SoundManager.Sound.SUMMONED)
...
const SOUND_CONFIG: Dictionary = {
	Sound.BACKGROUND1: {"path": "res://assets/sounds/combat1.ogg", "volume": 0.1, "looping": true},
	Sound.BACKGROUND2: {"path": "res://assets/sounds/combat2.ogg", "volume": 0.1, "looping": true},
	Sound.BACKGROUND3: {"path": "res://assets/sounds/combat3.ogg", "volume": 0.1, "looping": true},
	Sound.POSITIVE_EFFECT: {"path": "res://assets/sounds/positive_effect.ogg", "volume": 0.3, "looping": false},
	Sound.NEGATIVE_EFFECT: {"path": "res://assets/sounds/negative_effect.ogg", "volume": 0.3, "looping": false},
	Sound.MAGIC: {"path": "res://assets/sounds/magic.ogg", "volume": 0.3, "looping": false},
	Sound.ATTACK: {"path": "res://assets/sounds/attack.ogg", "volume": 0.3, "looping": false},
	Sound.SUMMON_DROP: {"path": "res://assets/sounds/summon_drop.ogg", "volume": 0.3, "looping": false},
	Sound.SUMMONED: {"path": "res://assets/sounds/summoned.ogg", "volume": 0.3, "looping": false},
	Sound.DAMAGED: {"path": "res://assets/sounds/damaged.ogg", "volume": 0.3, "looping": false},
	Sound.DEATH: {"path": "res://assets/sounds/death.ogg", "volume": 0.5, "looping": false},
	Sound.GAMEOVER: {"path": "res://assets/sounds/gameover.ogg", "volume": 0.5, "looping": false}
}
...
var background_tracks: Array = [Sound.BACKGROUND1, Sound.BACKGROUND2, Sound.BACKGROUND3]
...
func play_sound(sound_type: Sound, priority: int = PRIORITY_NORMAL) -> void:
...
func play_next_background_track() -> void:
	...
	var track: Sound = background_tracks[background_track_index]
...
func set_music_volume(volume: float) -> void:
	...
	if background_music_player != null and background_music_player.playing:
		var track: Sound = background_tracks[background_track_index % background_tracks.size()]
		var config: Dictionary = SOUND_CONFIG.get(track, {})
		var sound_volume: float = config.get("volume", 0.1)
		var final_volume: float = sound_volume * music_volume * master_volume
		background_music_player.volume_db = linear_to_db(final_volume)
...
func get_sound_priority(sound_type: Sound) -> int:
	match sound_type:
		Sound.GAMEOVER, Sound.DEATH:
...
func play_sound_by_name(sound_name: String) -> void:
	...
	for sound_type in Sound.values():
		var type_name: String = Sound.keys()[sound_type]
...
func play_spell_sound_by_class(spell_class_name: String) -> void:
	...
	Falls back to Sound.MAGIC if spell-specific sound doesn't exist.
	"""
	if spell_class_name.is_empty():
		play_sound(Sound.MAGIC)
		return
