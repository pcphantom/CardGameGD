...
func create_private_webrtc_match() -> String:
	...
	var match_id: String = webrtc_matchmaking.create_private_match()
...
func join_private_webrtc_match(match_id: String) -> bool:
	...
	var result: bool = webrtc_matchmaking.join_private_match(match_id)
...
func is_online() -> bool:
	return is_multiplayer_game and is_connected()
...
func is_opponent_connected() -> bool:
	return is_connected() and not remote_player_id.is_empty()
