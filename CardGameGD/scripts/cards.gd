...
const HAND_CARD_STATS_ADJUST_X: int = 0      # POSITIVE MOVES RIGHT, NEGATIVE MOVES LEFT
const HAND_CARD_STATS_ADJUST_Y: int = 24     # POSITIVE MOVES DOWN, NEGATIVE MOVES UP
...
const CARD_STATS_FONT_COLOR: Color = Color(1.0, 1.0, 1.0, 1.0)  # FONT COLOR FOR CARD STATS (R, G, B, A) - DEFAULT WHITE
