...
class_name BeeSoldier

## ============================================================================
## BeeSoldier.gd - EXACT translation of BeeSoldier.java
## ============================================================================
## Basic bee soldier creature with no special abilities.
## Simply calls parent implementations for all methods.
##
## Original: src/main/java/org/antinori/cards/characters/BeeSoldier.java
## Translation: scripts/creatures/bee_soldier.gd
##
...
# ============================================================================
# CONSTRUCTOR (Java: public BeeSoldier(...))
# ============================================================================

## Java: public BeeSoldier(Cards game, Card card, CardImage cardImage, int slotIndex, PlayerImage owner, PlayerImage opponent)
## Constructor to create a BeeSoldier creature
