...
const SOUND_CONFIG: Dictionary = {
	...
	SoundTypes.Sound.POSITIVE_EFFECT: {"path": "res://assets/sounds/PositiveEffect.ogg", "volume": 0.3, "looping": false},
	SoundTypes.Sound.NEGATIVE_EFFECT: {"path": "res://assets/sounds/NegativeEffect.ogg", "volume": 0.3, "looping": false},
