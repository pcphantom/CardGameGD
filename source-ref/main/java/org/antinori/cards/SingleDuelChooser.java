...
public class SingleDuelChooser implements EventListener {
    ...
    SelectBox<String> classesPlayer;
    SelectBox<String> classesOpponent;
    ...
    public void init(Cards game) {
        ...
        play.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                pi.getPlayerInfo().setPlayerClass(Specializations.fromTitleString(classesPlayer.getSelected()));
                oi.getPlayerInfo().setPlayerClass(Specializations.fromTitleString(classesOpponent.getSelected()));
        ...
        selectHostsButton.addListener(new InputListener() {
            @Override
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                if (selectHostsShown || Cards.NET_GAME != null) {
                    return true;
                }
        ...
        classesPlayer = new SelectBox(game.skin);
        classesPlayer.setItems(Specializations.titles());

        classesOpponent = new SelectBox(game.skin);
        classesOpponent.setItems(Specializations.titles());
